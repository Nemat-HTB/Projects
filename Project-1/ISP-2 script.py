...
def FortigateSetVNInfo():
  ...
  commands = ['config vpn ipsec phase1-interface' , 'edit Partner-VPN' , 'set remote-gw 2.2.2.2' , 'end']
...
if response == 0:
  ...
  ISP-1 is down now, and the script changed the configuration to ISP2.
